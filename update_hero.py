...
# Replace the hero section in HTML
html = re.sub(r'<!-- ===================== HERO ===================== -->\s*<section id="hero" class="hero">.*?</section>', hero_html, html, flags=re.DOTALL)
...
# Add btn--outline-white if it doesn't exist
if '.btn--outline-white' not in css:
    btn_white = """
.btn--outline-white {
